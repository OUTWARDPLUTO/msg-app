...
import WorkoutSection from './member/WorkoutSection.jsx';
import DietSection from './member/DietSection.jsx';
import StoreSection from './member/StoreSection.jsx';
import ProgressSection from './member/ProgressSection.jsx';
import ProfileScreen from './member/ProfileScreen.jsx';
import SettingsScreen from './member/SettingsScreen.jsx';
import { LanguageScreen } from './member/SettingsScreen.jsx';
    ...
    (async () => {
      try {
        ...
        if (perm.receive === 'granted') {
          ...
          PushNotifications.addListener('registration', token => console.log('[MSG] Push token:', token.value));
          PushNotifications.addListener('registrationError', err => console.warn('[MSG] Push registration error:', err));
          PushNotifications.addListener('pushNotificationReceived', n => console.log('[MSG] Push received:', n));
        }
      } catch { /* Not available in web/dev environment */ }
    })();
  }, []);
